...
$$\boldsymbol v (t) = (-R\omega\sin{\omega t}, R\omega\cos{\omega t}, 0) \\
\boldsymbol a (t) - (R\omega^2\cos{\omega t}, -R\omega^2\sin{\omega t}, 0)$$
...
$$ \lim\limits_{n\rightarrow \infty} \sum_{k=1}^n \vert \boldsymbol r(t_k)-\boldsymbol r(t_{k-1})\vert = \overgroup{AB}$$
...
$$ \boldsymbol \kappa(s) = {d^2 r \over ds^2}\ \vert \boldsymbol \kappa(s)\vert = \kappa (s) := Curvature$$  

$$ {d \over ds} ({\boldsymbol r'(t)\over \vert \boldsymbol r'(t)\vert}) = {d \over ds} ({\boldsymbol r'(t)\over \vert \boldsymbol r'(t)\vert}) \cdot {ds \over dt}= {\boldsymbol r''(t)\over {\vert \boldsymbol r'(t)\vert}^2 }$$

if $ \vert \boldsymbol r'(t) \vert = 1 $, $\boldsymbol \kappa = \boldsymbol r''(t)$ (acceration vetor)
