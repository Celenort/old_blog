...
- Break를 하기 위해서는 `\\`을 이용합니다.
	...
	```latex
		$$\sin{x} = x- {x^3 \over 3!} + {x^5 \over 5!} + \cdots + (-1)^n {x^{2n+1}\over {(2n+1)!}} \\ \\ n \rightarrow \infty$$
	```

	$$\sin{x} = x- {x^3 \over 3!} + {x^5 \over 5!} + \cdots + (-1)^n {x^{2n+1}\over {(2n+1)!}} \\ as \ \ n \rightarrow \infty$$
