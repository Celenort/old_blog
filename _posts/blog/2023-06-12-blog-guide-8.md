...
네비게이션 바 (목차 에 해당함) 을 수정하여 상단바/목차/네비게이션을 건드려 봅시다.
...
See the [**sidebars** documentation]({{ "/blog/layouts/#custom-sidebar-navigation-menu" | relative_url }}) for information on setting up a custom navigation menu.